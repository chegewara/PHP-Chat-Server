...
$help.="\n -e|--enc		Encrypted the connections*";
$help.="\n -d|--dev		Debugging mode**";
$help.="\n -h|--help		Display this screen";
$help.="\n\n*: By encrypting the connection, the text sent is encrypted by the client and decrypted by the server, there is NO SSL connection...";
