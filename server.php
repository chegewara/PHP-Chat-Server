...
$help.="\n -s|--setup		Setup the database, will create tables needed by server (it won't delete anything)";
...
while(true){
	...
	for($i=0;$i<$conf['max'];$i++) if($client[$i]['sock']!=null) $read[$i+1]=$client[$i]['sock'];
